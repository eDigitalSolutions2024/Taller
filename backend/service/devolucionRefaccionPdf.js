...
function copiaHtml(dev) {
  ...
  <div class="copia">
    ...
    <!-- SECCIÓN 1: MARCA / TÍTULO / No. -->
    <div class="s1">
      <div class="s1__marca">
        <div class="s1__nombre">Autoservicio D y G</div>
        <div class="s1__info">Av. Valentín Fuentes Varela #1779, Col. La Fuente, Juárez, Chih.</div>
      </div>
...
<style>
  * { margin: 0; padding: 0; box-sizing: border-box; }
  ...
  .s1__marca { width: 30%; }
  .s1__nombre { font-size: 11pt; font-weight: bold; text-transform: uppercase; }
  .s1__info { font-size: 6.5pt; color: #444; line-height: 1.3; }
  .s1__titulo { width: 50%; text-align: center; font-size: 15pt; font-weight: bold; color: #444; }
