...
const garageVehiculoSchema = new mongoose.Schema(
  {
    ...
    transmision:     { type: String, default: '' },
    cilindros:       { type: String, default: '' },
    combustion:      { type: String, default: '' },
    seguroRines:     { type: String, default: '' },
    llavesControl:   { type: String, default: '' },
