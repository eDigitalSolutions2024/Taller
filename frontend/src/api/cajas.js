...
export const listOrdenesCaja = (params) => http.get("/cajas", { params });

// Detalle de la orden + totales ya calculados (total, abonado, saldo)
export const getOrdenCaja = (id) => http.get(`/cajas/${id}`);

// Registrar un pago/abono/anticipo (con su comprobante: Nota de Venta o Remisión)
export const registrarPago = (id, payload) => http.post(`/cajas/${id}/pagos`, payload);
...
export const agregarDescuento = (id, payload) => http.post(`/cajas/${id}/descuentos`, payload);
...
// Impresión de comprobantes — imprime el pago indicado por pagoId.
