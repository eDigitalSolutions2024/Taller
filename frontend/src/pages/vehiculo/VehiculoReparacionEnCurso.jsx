            ...
            <div className="card-body p-0">
              <table className="table table-sm table-bordered mb-0">
                <tbody>
                  ...
                  <tr><th className="ps-2">Marca</th><td>{orden.marca || "-"}</td></tr>
                  <tr><th className="ps-2">Modelo</th><td>{orden.modelo || "-"}</td></tr>
                  <tr><th className="ps-2">Año</th><td>{orden.anio || "-"}</td></tr>
                  <tr><th className="ps-2">Color</th><td>{orden.color || "-"}</td></tr>
                  <tr><th className="ps-2">Serie</th><td>{orden.serie || "-"}</td></tr>
                  <tr><th className="ps-2">Placas</th><td>{orden.placas || "-"}</td></tr>
                  <tr><th className="ps-2">KMS / Millas</th><td>{orden.kmsMillas || "-"}</td></tr>
                </tbody>
              </table>
            </div>
          </div>
          ...
          <div className="card h-100">
            ...
            <div className="card-body p-0">
              {personalRows.length > 0 ? (
                ...
                <table className="table table-sm table-bordered mb-0">
                  <tbody>
                    <tr><th className="ps-2" style={{ width: "40%" }}>Asesor</th><td>{orden.asesorServicio || "-"}</td></tr>
                    <tr><th className="ps-2">Mecánico</th><td>{orden.mecanicoPrincipal || "-"}</td></tr>
                    <tr><th className="ps-2">Refaccionario</th><td>{orden.refaccionario || "-"}</td></tr>
                  </tbody>
                </table>
              )}
            </div>
