...
export default function VehiculosConsultaCanceladas() {
    ...
    <div className="card card-body">
      ...
      <form className="row g-2 align-items-end mb-3" onSubmit={handleBuscar}>
        ...
        <div className="col-md-4 text-end">
          <small className="text-muted">Doble clic en una fila para abrir la orden.</small>
        </div>
      </form>
        ...
        <table className="table table-sm table-bordered align-middle">
          ...
          <tbody>
            {rows.length === 0 && !loading && (
              <tr>
                <td colSpan={esAdmin ? 9 : 8} className="text-center">
            ...
            {rows.map((o) => {
              const clienteNombre = o.nombreGobierno || o.nombreCliente || o.cliente?.nombre || "";
              const telefono =
                (o.telefonoFijoLada ? o.telefonoFijoLada + " " + (o.telefonoFijo || "") : o.telefonoFijo) ||
                o.celular ||
                "";

              return (
                <tr key={o._id} onDoubleClick={() => handleRowDblClick(o._id)} style={{ cursor: "pointer" }}>
                  ...
                  <td>{(o.marca || "") + (o.modelo ? ` / ${o.modelo}` : "")}</td>
                  <td>{o.anio}</td>
                  <td>{o.placas}</td>
                  <td>{o.fechaRecepcion ? new Date(o.fechaRecepcion).toLocaleDateString("es-MX") : ""}</td>
                  <td>{telefono}</td>
                  <td>{o.estadoOrden || ""}</td>
                  {esAdmin && (
                    <td>
