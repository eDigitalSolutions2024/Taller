...
import { getUsuariosActivos } from "../../../api/users";
...
export default function DevolucionRefaccion() {
  ...
  // Typeahead de "Comprador": busca entre los usuarios activos del sistema
  ...
  // Filtrado local del typeahead de "Comprador".
            ...
            <div className="row g-3">
              ...
              <div className="col-sm-4 position-relative">
                ...
                <input
                  ...
                  onBlur={() => setTimeout(() => setMostrarUsuarios(false), 150)}
                  autoComplete="off"
                  placeholder="Quién compra/gestiona la devolución"
                />
                {mostrarUsuarios && compradorFiltrados.length > 0 && (
                  <div className="list-group position-absolute w-100 shadow-sm" style={{ zIndex: 20 }}>
                ...
                <div className="form-text">Se propone tu usuario; búscalo entre los usuarios activos.</div>
              </div>
