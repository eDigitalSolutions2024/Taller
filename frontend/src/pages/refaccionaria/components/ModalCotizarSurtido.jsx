...
import ModalBuscarCodigo from "./ModalBuscarCodigo";
...
export default function ModalCotizarSurtido({ refaccionNombre, cant, vehiculo, prefill, onGuardar, onClose }) {
  ...
  const seleccionarDeAlmacen = (item) => {
    ...
    setDetalle((prev) => ({
      ...prev,
      codigo: item.codigo || "",
      unidad: item.unidadMedida || prev.unidad || "",
    ...
    <>
      ...
      >
        ...
        <div className="p-3" style={{ overflowY: "auto" }}>
          ...
          <div className="row g-2">
            <div className="col-6 col-md-4">
              ...
              <select className="form-select form-select-sm" value={detalle.unidad} onChange={(e) => cambiar("unidad", e.target.value)}>
                <option value="">—</option>
            ...
            <div className="col-6 col-md-4">
              ...
              <select className="form-select form-select-sm" value={detalle.tipo} onChange={(e) => cambiar("tipo", e.target.value)}>
            ...
            <div className="col-6 col-md-4">
              ...
              {detalle.proveedor === "Almacén" ? (
                <div className="d-flex align-items-center gap-2">
                  ...
                  <button type="button" className="btn btn-outline-secondary btn-sm" title="Cambiar proveedor" onClick={() => cambiar("proveedor", "")}>✕</button>
                </div>
              ) : (
                <div className="d-flex align-items-center gap-1">
                  ...
                  />
                  <button type="button" className="btn btn-outline-success text-nowrap px-3" title="Usar almacén como proveedor" onClick={() => cambiar("proveedor", "Almacén")}>
                    Almacén
                  </button>
                </div>
              )}
            ...
            <div className="col-6 col-md-4">
              ...
              {detalle.proveedor === "Almacén" ? (
                <div className="d-flex gap-1">
                  ...
                  />
                  <button type="button" className="btn btn-outline-primary btn-sm text-nowrap" onClick={() => setModalAlmacenOpen(true)}>
                    Buscar
                  </button>
                </div>
              ) : (
            ...
            <div className="col-6 col-md-2">
              ...
              <select className="form-select form-select-sm" value={detalle.moneda} onChange={(e) => cambiar("moneda", e.target.value)}>
            ...
            <div className="col-4 col-md-2">
              ...
              <select className="form-select form-select-sm" value={detalle.core} onChange={(e) => cambiar("core", e.target.value)}>
                <option value="">—</option>
        ...
        <div className="p-3 border-top d-flex justify-content-end gap-2">
          ...
          <button type="button" className="btn btn-primary px-4" onClick={handleGuardar}>Guardar detalle</button>
        </div>
      </div>
