...
// Distinto del catálogo de BD Códigos — ver BDCodigos.jsx.
...
export default function ServiciosCatalogo() {
  ...
  const abrirModal = (servicio) => {
    ...
    setModalRefacciones((servicio.refacciones || []).map((r) => ({ ...r })));
        ...
        <div className="col-12 col-xxl-10">
          <div className="card shadow-sm border-0 mb-4">
            ...
            <div className="card-body">
                    ...
                    <tr key={idx}>
                      <td>
                        <input
                          ...
                          onChange={(e) => cambiarRefaccionForm(idx, "nombre", e.target.value)}
                        />
                      </td>
                      <td className="text-center">
                        <input
                          ...
                          onChange={(e) => cambiarRefaccionForm(idx, "obligatoria", e.target.checked)}
                        />
                      </td>
                      <td className="text-center">
                        <button
              ...
              <button type="button" className="btn btn-outline-secondary btn-sm" onClick={agregarRefaccionForm}>
                + Agregar refacción
              </button>
          ...
          <div className="card shadow-sm border-0">
            ...
            <div className="card-body">
              {cargando ? (
                ...
                <div className="alert alert-info mb-0">Aún no hay servicios creados.</div>
              ) : (
                <div className="row row-cols-2 row-cols-md-3 g-3">
                  {servicios.map((s) => (
                    <div className="col" key={s._id}>
                      <button
                        type="button"
                        className="btn btn-outline-primary w-100 h-100 text-start p-3"
              ...
              <div className="d-flex gap-2 align-items-end mt-2">
                <div className="flex-grow-1">
                  ...
                  <input
                    ...
                    onChange={(e) => setNuevaRefaccionModal((prev) => ({ ...prev, nombre: e.target.value }))}
                  />
                </div>
                ...
                <button type="button" className="btn btn-outline-secondary btn-sm" onClick={agregarRefaccionModal}>
                  + Agregar
                </button>
              </div>
            </div>
