...
export default function CajasBuscarOrden() {
  ...
  // Cualquier cambio en los filtros regresa a la página 1.
  useEffect(() => {
    setPage(1);
          ...
          <div className="row g-2 align-items-end mb-3">
            <div className="col-md-6">
              <label className="form-label mb-0">
                Orden de Servicio, Cliente o Número de Serie
              </label>
              <input
                type="text"
              ...
              {rows.map((r) => (
                <tr key={r._id} style={{ cursor: "pointer" }} onClick={() => irAOrden(r)}>
                  ...
                  <td className="text-center">
                    {r.garantia && <span className="badge bg-info text-dark me-1">Garantía</span>}
