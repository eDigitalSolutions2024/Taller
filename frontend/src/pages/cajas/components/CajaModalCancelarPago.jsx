...
// Solo admin (ver CajaOrdenDetalle): cancela un abono, anticipo, remisión o
// nota de venta ya registrado. El folio se conserva; el pago solo queda
// marcado como cancelado (badge en el historial).
      ...
      <div className="modal-dialog modal-dialog-centered">
        <div className="modal-content">
          <div className="modal-header">
            <h5 className="modal-title fw-bold">Cancelar Pago</h5>
