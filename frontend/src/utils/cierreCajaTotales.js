// Espejo de backend/utils/cierreCajaTotales.js: los totales del cierre nunca
// se persisten, siempre se recalculan a partir de los conteos/capturas guardadas.
export const TERMINALES_KEYS = [
  "BANREGIO",
  "AMERICAN EXPRESS",
  "BANAMEX",
  "BANORTE",
